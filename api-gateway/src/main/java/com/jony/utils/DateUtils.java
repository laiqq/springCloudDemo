...
//    System.out.println(""+days+"天"+hours+"小时"+minutes+"分");
    ...
    /**
     * 功能：返回当前时间距离今天24点相差多少秒
     *
     * @param date
     * @return
     */
    public static long getToadyMillis(Date date) {
        if (date == null) {
            date = new Date();
        }
        return (23-getHour(date))*3600+(59-getMinute(date))*60+59-getSecond2(date);
    }
...
//        System.out.println(getSubTwoTimeYY("2016-04-29 12:00:15","2016-05-29 12:05:16"));
//        System.out.println(getAddDay(10));
//    }
